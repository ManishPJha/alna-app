        ...
        <div className="p-3 bg-white border-t border-gray-200 rounded-b-2xl">
            ...
            <div className="flex gap-2">
                <input
                    ...
                    className="flex-1 px-3 py-2 border text-black border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-xs bg-gray-50 focus:bg-white transition-colors"
                ...
                <button
                    ...
                    style={{
                        background: !value.trim() || isLoading || disabled ? '#9CA3AF' : 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)'
                    }}
                >
